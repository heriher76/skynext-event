    ...
    <header id="header" class="navbar">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="javascript:void(0);">
                <img style="width: 150px;" class="logo" alt="Attendize"
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown profile">
                    ...
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="meta">
                            <span
                                class="text ">{{ isset($organiser->name) ? $organiser->name : $event->organiser->name }}</span>
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li>
                            <a data-href="{{ route('showEditUser') }}" data-modal-id="EditUser"
                                class="loadModal editUserModal" href="javascript:void(0);"><span
                                    class="icon ico-user"></span>@lang('Top.my_profile')</a>
                        </li>
                        <li class="divider"></li>
                        ...
                        {{-- <li class="divider"></li> --}}
                        {{-- <li><a target="_blank"
                                href="https://github.com/Attendize/Attendize/issues/new?body=Version%20{{ config('attendize.version') }}"><span
                                    class="icon ico-megaphone"></span>@lang('Top.feedback_bug_report')</a></li> --}}
                        <li class="divider"></li>
                        <li><a href="{{ route('logout') }}"><span class="icon ico-exit"></span>@lang('Top.sign_out')</a>
                        </li>
                    </ul>
                </li>
            </ul>
